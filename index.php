...
@require_once("project/entity.php");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-header bg-white padding-10 text-center form-social-header">
                                <h2><strong>Acesso</strong> social</h2>                
                            </div>
                            <div class="social-buttons margin-top-20">
                                <button type="button" class="btn btn-lg btn-block btn-primary btn-flat bg-facebook btn-raised"><i class="fa fa-facebook pull-left"></i>Facebook</button>
                                <button type="button" class="btn btn-lg btn-block btn-blue btn-flat bg-twitter btn-raised"><i class="fa fa-twitter pull-left"></i>Twitter</button>
                                <button type="button" class="btn btn-lg btn-block btn-danger btn-flat bg-google btn-raised"><i class="fa fa-google-plus pull-left"></i>Google</button>
                            </div>
