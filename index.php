            ...
            <div id="sidebar" class="nav-collapse md-box-shadowed">
                ...
                <div class="leftside-navigation leftside-navigation-scroll">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class=' '><a href="#" class="hvr-bounce-to-right-sidebar-parent active"><span class='icon-sidebar icon-home fa-2x'></span><span>Dashboard</span></a>
                        </li>
                                                ...
                                                <ul class="list-unstyled top_profiles">
                                                    <li class="media event">
                                                        ...
                                                        <div class="media-body">
                                                            <a class="title" href="#">Jane Dane</a>
